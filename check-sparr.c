...
__CUT_BRINGUP__full_spgroup()
{
    ...
    r = spgroup_set(g, 1, (void *) 11);
    ASSERT(!r, "Just trying to allocate here");
    r = spgroup_set(g, 2, (void *) 13);
    ASSERT(!r, "Just trying to allocate here");
}
...
__CUT_BRINGUP__full_sparr()
{
    ...
    r = sparr_set(a, 0, (void *) 7);
    ASSERT(!r, "Just trying to allocate here");
    r = sparr_set(a, 1, (void *) 11);
    ASSERT(!r, "Just trying to allocate here");
    r = sparr_set(a, 2, (void *) 13);
    ASSERT(!r, "Just trying to allocate here");
}
